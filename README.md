...
[![CI](https://github.com/moonggae/KMedia/actions/workflows/ci.yml/badge.svg)](https://github.com/moonggae/KMedia/actions/workflows/ci.yml)
...
val protectedMusic = Music(
    id = "protected-track-1",
    title = "Protected Track",
    uri = "https://media.example.com/tracks/protected-track-1/stream",
    cacheKey = "protected-track-1-audio",
    mimeType = "audio/mpeg",
